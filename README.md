...
**[BOOKSTORE]** is a web app thats used to store different components of the app and also display books when put into use.
...
## 👥 Authors <a name="authors">Nowembabazi Nickson</a>
